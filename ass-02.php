...
$selection=array_filter($students,function($student) use ($average){
    return $student['total']>=$average;
});
$summation=array_reduce($selection,function($carry,$student){
$carry += $student['total'];
return $carry;
},0);
printf("Summation of total score greater than or equal%7.2f :%7.2f",$average,$summation);
